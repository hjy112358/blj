        ...
        <div class="signMainbox">
            <div class="myorder">
                <div class="signinTitle " style="margin-top:20px">
                    ...
                    <span class="allorder"><a href="{:url('order/orderlist_all')}">查看全部订单</a></span>
                </div>
                <div class="orderStatus clearfix">
                    <div class="orderstatusbox">
                        <ul class="clearfix">
                            <li>
                                <a href="{:url('order/orderlist_daifu')}">
                                    <div>
                                        <div class="statimg  pos-r">
                                            <img src="__STATIC__/images/newimg/usr/daifukuan.png" alt="" width="28px"
                                                height="20px">
                                            <i class="maincolorbg  pos-a">{$daifu}</i>
                                        </div>
                            ...
                            <li>
                                <a href="{:url('order/orderlist_weifa')}">
                                    <div>
                                        <div class="statimg  pos-r">
                                            <img src="__STATIC__/images/newimg/usr/daishou.png" alt="" width="23px"
                                                height="23px">
                                            <i class="maincolorbg pos-a">{$weifa}</i>
                                        </div>
                            ...
                            <li>
                                <a href="{:url('order/orderlist_daishou')}">
                                    <div>
                                        <div class="statimg  pos-r">
                                            <img src="__STATIC__/images/newimg/usr/daifahuo.png" alt="" width="25px"
                                                height="20px">
                                            <i class="maincolorbg pos-a">{$daishou}</i>
                                        </div>
                ...
                <div class="propertylist pos-r">
                    <ul>
                        <li class="flex align-c jus-start">
                            <a href="{:U('User/shareCode')}" class="flex align-c jus-start">
                        ...
                        <li class="">
                            <a href="{:U('User/memberRegistrate')}" class="flex align-c jus-start">
                                <div class="flex align-c">
